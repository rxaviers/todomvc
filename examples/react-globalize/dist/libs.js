...
define('director', function() {return Router;});
/**
...
(function(root, factory) {
    ...
    if (typeof define === "function" && define.amd) {
        // AMD
        define('react-globalize/src/core',["globalize-runtime", "react"], factory);
    } else if (typeof exports === "object") {
        // Node, CommonJS
        module.exports = factory(require("globalize-runtime"), require("react"));
    } else {
        // Global
...
(function(root, factory) {
    ...
    if (typeof define === "function" && define.amd) {
        // AMD
        define('react-globalize/src/message',["globalize-runtime", "react", "./core"], factory);
    } else if (typeof exports === "object") {
        // Node, CommonJS
        module.exports = factory(require("globalize-runtime"), require("react"), require("./core"));
    } else {
        // Global
        root.ReactGlobalizeMessage = factory(root.Global, root.React);
    }

}(this, function(Globalize, React, core) {
...
function messageSetup(componentProps, instance, args) {
    ...
    function setMessage(message) {
        ...
        message = prettifyComments(message);
    ...
    function _replaceElements(string, elements) {
        ...
        return Object.keys(elements).reduce(function(ret, key) {
            ...
            ret.forEach(function(string, i) {
                var aux, clone, contents, regexp, regexp2;
...
function prettifyComments(comment) {
    function multilineTrim(text) {
        var indents = text.slice(1).map(function(line) {
            return (line.match(/^ +/) || [""])[0];
        });
        var minIndent = indents.slice(1).reduce(function(ret, i) {
            if (i < ret) {
                ret = i;
            }
            return ret;
    ...
    if (/\n/.test(comment)) {
        return multilineTrim(comment.trim().split("\n"));
    }
    return comment.trim();
}
...
Globalize.prototype.messageFormatter = function(pathOrMessage) {
    var aux = {};
    if (this.cldr && this.cldr.get(["globalize-messages/{bundle}", pathOrMessage]) === undefined) {
        aux[this.cldr.attributes.bundle] = {};
        aux[this.cldr.attributes.bundle][sanitizePath(pathOrMessage)] = prettifyComments(pathOrMessage);
        Globalize.loadMessages(aux);
    }
    return messageFormatterSuper.apply(this, arguments);
};

var message = core("formatMessage", ["path", "variables"]);
var format = message.format;
message.format = function() {
    messageSetup(this.props, this.instance, this.args);
    return replaceElements(this.props, format.call(this));
};
...
(function( root, factory ) {
	...
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD
		define('globalize-runtime/message',[
			"../globalize-runtime"
		], factory );
	} else if ( typeof exports === "object" ) {

		// Node, CommonJS
		module.exports = factory( require( "globalize-runtime/dist/globalize-runtime" ) );
	} else {
...
(function( root, factory ) {
	...
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD
		define('globalize-runtime/plural',[
			"../globalize-runtime"
		], factory );
	} else if ( typeof exports === "object" ) {
...
define('react-globalize/message',["react", "./src/message", "globalize-runtime/message", "globalize-runtime/plural"], function(React, message) {

return React.createClass(message);
